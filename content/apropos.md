...
La morphopsychologie est l’un des outils que j’utilise dans ma pratique. Elle permet d’observer les liens entre les formes du visage et un certain nombre de dispositions psychologiques.

Cette lecture apporte des repères concrets pour mieux comprendre notamment :
...
* l’orientation et les parcours professionnels,
* la communication interpersonnelle.

## Au sein du cabinet Sémaphore

J’interviens auprès de :

* jeunes à partir de 14 ans dans leur réflexion d’orientation,
* adultes en transition ou en reconversion professionnelle,
* personnes qui souhaitent pitcher avec impact leur métier ou leur entreprise,
...
* [bilans de compétences](https://semaphore.fr/orientation), 
* [consultations de morphopsychologie,](https://semaphore.fr/consultation) avec ou sans accompagnement à la construction du pitch,
* [formations, ateliers et conférences](https://semaphore.fr/consultation).
